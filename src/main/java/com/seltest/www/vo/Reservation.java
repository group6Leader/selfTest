...
public class Reservation {
	...
	public Reservation(int res_Num, String cust_Name, String res_Date, String hos_Name, int cust_Num, String cust_Id,
			String hos_Addr, String hos_Homepage, String hos_Phone, String category) {
		super();
	...
	public String toString() {
		return "Reservation [res_Num=" + res_Num + ", cust_Name=" + cust_Name + ", res_Date=" + res_Date + ", hos_Name="
				+ hos_Name + ", cust_Num=" + cust_Num + ", cust_Id=" + cust_Id + ", hos_Addr=" + hos_Addr
				+ ", hos_Homepage=" + hos_Homepage + ", hos_Phone=" + hos_Phone + ", category=" + category + "]";
	}
